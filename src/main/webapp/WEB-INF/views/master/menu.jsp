...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.manager" access="hasRole('Manager')">
			<acme:menu-suboption code="master.menu.manager.tasks.list" action="/manager/task/list"/>
			<acme:menu-separator/>
			<acme:menu-suboption code="master.menu.manager.tasks.create" action="/manager/task/create"/>
			<acme:menu-separator/>
			<acme:menu-suboption code="master.menu.manager.workplans.list" action="/manager/workplan/list"/>
			<acme:menu-separator/>
			<acme:menu-suboption code="master.menu.manager.workplans.create" action="/manager/workplan/create"/>
		</acme:menu-option>
